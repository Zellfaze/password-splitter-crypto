...
describe("UShare", () => {
  const shareStarter = {id: 1, data: "801649ec44b6e582da82be0c281d8bc9708", bits: 8};
  const shareStarter2 = {id: 2, data: "802c8219596dcb05a4e5641998aadca338c", bits: 8};
  const shareJSON1 = '{"id":1,"data":"801649ec44b6e582da82be0c281d8bc9708","bits":8,"type":"plain"}';
  const shareJSON2 = '{"id":1,"data":"802c8219596dcb05a4e5641998aadca338c","bits":8,"type":"plain"}';
...
describe("IShare", () => {
  const shareStarter = {id: 1, data: "encrypteddata", bits: 8, salt: "abcdef", iv:"aaaaaaaaa"};
  const shareJSON = '{"id":1,"data":"encrypteddata","bits":8,"salt":"abcdef","iv":"aaaaaaaaa","type":"invite"}';
...
describe("EShare", () => {
  const shareStarter = {id: 1, data: "encrypteddata", bits: 8, salt: "abcdef", iv:"aaaaaaaaa", username: "user1"};
  const shareJSON = '{"id":1,"data":"encrypteddata","bits":8,"salt":"abcdef","iv":"aaaaaaaaa","username":"user1","type":"encrypted"}';
