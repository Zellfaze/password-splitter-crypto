      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            sharepackage1 = new _SharePackage["default"].ESharePackage([ushareGroup1, ushareGroup2], eoptions);
          ...
          case 6:
            ...
            sharepackage2 = new _SharePackage["default"].ESharePackage([isharegroup, ushareGroup2], eoptions);
...
describe("USharePackage", function () {
  ...
  test("create from data works", function () {
    var sharepackage = new _SharePackage["default"].USharePackage("Attack at dawn", uoptions);
    expect(sharepackage.plaintext).toBe("Attack at dawn");
    expect(sharepackage.name).toBe("Secret message");
    expect(sharepackage.description).toBe("OMG SO SECRET!");
  });
  test("create from JSON works", function () {
    var ushareJSON = '{"plaintext":"Attack at dawn","dbid":"8f5d59f9-e399-4b8c-8ade-c99a83b8ae90","name":"Secret message","description":"OMG SO SECRET!"}';
